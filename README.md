...
<p align="center">
  <img src="assets/demo.gif" width="640" alt="游戏实机演示">
  <br>
  <em>游戏实机演示 - AI 自动执行任务</em>
</p>
...
- **obtain(旗舰技能)**:一步"搞到任何东西"——本地递归解决工具阶梯/采集/熔炼/合成整条链。
  `obtain diamond ×3` 会自动:检查镐等级→没铁镐就去合铁镐→没铁锭就挖铁烧铁→没石镐就先做石镐→…全程零 token。
  知识表覆盖常见矿物/原木/熔炼产物,可合成物品自动走配方书。
...
**生存保障层/反射层**(任务执行期间自动生效,可在配置关闭):饿了自动吃(黑名单食物除外)、
**光照过低自动插火把**(需背包有火把)、**工具快坏自动换备用/预警**、
